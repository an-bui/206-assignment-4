...
caption <- paste(strwrap("Figure 1. Lobster counts (solid lines) vs. lobster trap counts (dashed lines) at MPAs (green) and non-MPAs (yellow) from 2012-2017.", width = 110), collapse = "\n")
...
abund_traps_plot <- ggplot(abund_by_yearssite, aes(x = YEAR, y = count)) +
  ...
  labs(x = "Year", y = "Counts", caption = caption) +
...
caption3 <- paste(strwrap("Figure 3. Carapace lengths (mm) surveyed at MPA (green) and non-MPA (yellow) sites in 2012 and 2017.", width = 110), collapse = "\n")
