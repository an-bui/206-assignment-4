...
##### Marine Protected Areas in the SBC LTER
  ...
  Of the five focal sites within the Santa Barbara Coastal Long Term Ecological Research (SBC LTER) sites, two are MPAs (Isla Vista, Naples Reef), and three (Arroyo Quemado, Carpinteria, Mohawk) are unprotected and open to both commercial and recreational fishing. Isla Vista and Naples Reef were designated MPAs in 2012. This design is a natural experiment to understand the effects of fishing pressure on the population dynamics of integral species to the kelp forest, such as the CA spiny lobster. When integrating lobster surveys with algal and invertebrate surveys also being conducted at these sites, the SBC LTER is able to better construct a holistic profile of kelp forest community dynamics in response to fishing pressure.

##### Long term surveys
  Lobster surveys began in 2012 and were conducted annually in late summer as part of a long-term monitoring effort within Santa Barbara Coastal Long Term Ecological Research (SBC LTER) sites. Lobster count and sizes are recorded by divers on SCUBA on four 60 x 5m transects approximately 1km offshore at five sites in the SBC LTER (Fig. 1).  
...
The following report analyzes lobster abundances and sizes at five SBC LTER locations, two of which are MPAs (Isla Vista, Naples Reef), and three non-MPAs (Arroyo Quemado, Carpenteria, Mohawk). We use monitoring data at these five sites to ask:
    ...
    2. how lobster mean size compares across all five sites in 2017, and  
...
```
=======
 Lobster abundance has generally increased between 2012 and 2017, though raw increases in abundance differ between sites. Comparing MPA sites, Isla Vista saw a net increase of 580 lobsters within the transect area, while Naples Reef had a net increase of 106 lobsters. In non-MPA sites, Arroyo Quemado saw a net increase of 29 lobsters, Mohawk Reef populations increased by 95 lobsters, and the largest increase was at Carpinteria with 627 lobsters. The differences in increasing abundance at the MPA sites indicates that there may be environmental factors that contribute to the reproductive success of one population over the other; for example, Isla Vista may ... [idk about this, could just be making shit up so feel free to take out]
 As expected at non-MPA sites, when fishing pressure decreases, lobster abundance increases. At all three non-MPA sites, decreases in fishing pressure are generally followed by increases in lobster abundance. Fishing pressure has fluctuated greatly at all three sites but shows a net decrease between 2012 and 2017. While the effects on the lobster abundance can be slight (e.g. Arroyo Quemado) or large (Carpinteria), lobster populations are responding to fluctuations in fishing pressure. [again, making this up. idk if right]
 - your points about Mohawk here
>>>>>>> adb9c6d07972ba42ec1b502184a2cf161f2dd6ef

##### Lobster size change over time at MPA sites
```{r compare mean lob size between 2012 and 2017 for MPAs}
...
#pdf("fig_4.pdf", width = 8, height = 6)
...
#caption2 <- paste(strwrap("Figure 2. Carapace lengths (CL, mm) of CA spiny lobster at five locations in the Santa Barbara Channel (2017). CL estimated on SCUBA in study transects at five locations: Isla Vista, Naples Reef, Arroyo Quemado, Carpenteria, Mohawk. MPAs (green) were designated in 2012. Unprotected areas (yellow) are fished annually. Dashed line represents the mean CL across all five sites in 2017. Mean CL only differed significantly between Naples Reef-Isla Vista (_p_ = 0.004) and Naples Reef-Carpenteria (_p_ = 0.02). All other pairwise comparisons yielded no signficant differences (one-way ANOVA, F(4) = 3.42, p < 0.01) with post-hoc Tukey's HSD (alpha = 0.05). Asterisks indicate values that differed significantly between sites (***p < 0.005, ** p < 0.05). Data from Reed (2017).", width = 110), collapse = "\n")
...
```
    In 2017, all sites have significantly different mean lobster carapace length (one-way ANOVA, F(4) = 3.42, _p_ < 0.01, $\alpha$ = 0.05) but pairwise comparison with post-hoc Tukey's HSD shows that only mean lobster carapace length at Naples Reef and Isla Vista and Naples Reef and Carpinteria are significantly different (Figure size_2017_boxplot, $\alpha$ = 0.05). 
  25% of lobsters at all three non-MPA sites are at or above the legal size limit of 82.6mm (Table lob_prop). However, at Naples Reef, 33% of lobsters are above the legal size limit. This indicates [something about MPAs working? idk Naples Reef lob size didn't change significantly between 2012 and 2017 so maybe the point could be something like "some places just have bigger lobs and we need to figure out what it is about that place that makes it such a good refugia for lobsters"]
...
17. Engle JM (1979) Ecology and growth of juvenile spiny lobster (Panulirus interruptus) (Randall). Dissertation: University of Southern California. 
18. Lester SE, Halpern BS, Grorud-Colvert K, Lubchenco J, Ruttenberg BI, Gaines SD, Airame S, Warner RR (2009) Biological effects within no-take marine reserves: a global synthesis. Marine Ecology Progress Series. 384:33-46.
19. Kay MC, Lenihan HS, Kotchen MJ, Miller CJ (2012) Effects of marine reserves on California spiny lobster are robust and modified by fine-scale habitat features and distance from reserve borders. Marine Ecology Progress Series. 451:137-150.
