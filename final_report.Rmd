...
```
  In 2017, 75% of lobsters at all three non-MPA sites are at or below the legal size limit of 82.6mm (Table lob_prop). However, at MPA sites, there is a significant difference in mean lobster length (Figure size_2017_boxplot, one-way ANOVA, F(4) = 3.42, _p_ < .01). 
