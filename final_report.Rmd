...
#### Introduction
  ...
  Beyond their ecological importance, CA spiny lobster supports a valuable commercial fishery extending from Point Conception to the US-Mexico border, generating over $18 million in ex-vessel landings annually (FMP 2016). Restrictions on commercial takes include (1) a minimum carapace length (CL) limit (82.6 mm), which allows most individuals to reproduce for up to two years before reaching the legal size limit and (2) a seasonal fishery closure (March - Ocotober), which protects females from harvest during the species' spawning period. These management measures have ensured a stable lobster stock since 2000, though an increase in commercial fishing effort raises questions about the long-term sustainability of the commercial fishery.
  
  An avid recreationally fishery extends even further north to San Luis Obispo County, and contributes an estimated $40 million in consumer spending to the state's economy each year (FMP 2016). Most lobsters are collected by divers, but hoop-net capture has also risen in popularity over the past decade. Recreational fishers are required by California Fish and Wildlife (CDFW) to record lobstering activity on report cards, which are returned seasonally to CDFW.
  
  The creation of 50 marine protected areas (MPAs) in southern California in 2012....
