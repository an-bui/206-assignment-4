...
abund_2012_2017 <- abund %>% 
  ...
  select(YEAR, site_full, SIZE)

stacked_data <- melt(data = abund_2012_2017, na.rm = TRUE, value.name = "SIZE")
# abund_stacked <- abund_2012_2017 %>% 
#   melt(id = c("YEAR", "SITE"))
...
sizes_1217_plot <- ggplot(abund_2012_2017, aes(x = site_full, y = SIZE, fill = YEAR)) +
