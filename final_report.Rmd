...
abund_2017$site_full <- factor(abund_2017$site_full, levels=c("Isla Vista", "Naples Reef","Arroyo Quemado", "Carpinteria", "Mohawk Reef"))

caption2 <- paste(strwrap("Figure 3. Carapace lengths (mm) at MPA (green) and non-MPA (yellow) sites in 2017.", width = 110), collapse = "\n")

stats <- summarySE(abund_2017, measurevar = "SIZE", groupvars = c("site_full"), na.rm = TRUE)
