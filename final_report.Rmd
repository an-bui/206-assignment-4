...
# sizes_1217_year_plot <- ggplot(abund_2012_2017, aes(x = YEAR, y = SIZE, fill = YEAR)) +
...
#           legend.position = "none")
# 
# sizes_1217_year_plot # facet wrap by year

sizes_1217_site_plot <- ggplot(abund_2012_2017, aes(x = YEAR, y = SIZE)) +
